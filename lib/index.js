(function (global, factory) {
    ...
    const SLIM_FLAGS = SLIM_KEYS.reduce((cur, next) => {
        // TODO if remove 'as string' Type 'string' is not assignable to type 'never'. ? why
        cur[next] = genSlimKey(next);
        return cur;
    }, {});
    function genSlimKey(x) {
    ...
    const _create = function (target, domDelay, originalObservable, originalPath) {
        ...
        if (isSlimArray(target)) {
            if (!target.hasOwnProperty("__slim_length"))
                ...
                target.__slim_length = target.length;
        }
        let changes = [];
        /**
        ...
        const handler = {
            get: function (target, property) {
                ...
                if (targetProp instanceof Object && targetProp !== null && target.hasOwnProperty(property)) {
                    ...
                    if (targetProp.__slim_isProxy === true)
                        targetProp = targetProp.__slim_getTarget;
            ...
            set: function (target, property, value, receiver) {
                ...
                if (value && value.__slim_isProxy)
                    value = value.__slim_getTarget;
                // was this change an original change or was it a change that was re-triggered below
                var originalChange = true;
                if (dupProxy === proxy) {
                    originalChange = false;
    ...
    exports.SLIM_FLAGS = SLIM_FLAGS;
    exports.SLIM_KEYS = SLIM_KEYS;
    exports.create = create;
    exports.default = index$1;
    exports.genSlimKey = genSlimKey;
